...
const EPKView = ()=> {
    ...
    <div className="EPKRootDiv MainView">
        ...
        <section className="videoSection">
            <h3> Videos</h3>
        <iframe style={{width:"90%", height:"35em", padding:"1em"}} src="https://www.youtube.com/embed/Qjz_NmehpAg" title="the feeling" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        <iframe style={{width:"90%", height:"30em", padding:"1em"}} src="https://www.youtube.com/embed/qM093Q7kxhQ?si=a6HtGwgBdsjB1xdb" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
